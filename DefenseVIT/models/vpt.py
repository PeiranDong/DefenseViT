...
class VIT(nn.Module):
    def __init__(self, modelname: str, num_classes: int, pretrained: bool = True):
        super().__init__()
        self.vit_model = create_model(modelname, num_classes=num_classes, pretrained=pretrained)
